...
def guardar_datos(nombre_archivo, datos):
    with open(nombre_archivo, 'w') as archivo:
        archivo.write(datos.to_json(orient='records', date_format='iso'))  # Usamos orient='records' para formato correcto
...
categorias = ["Casa", "Deporte", "Alimentación / Hogar", "Salir Fuera"]
